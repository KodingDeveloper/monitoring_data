                    ...
                    >
                        <div class="inline-block px-3" style="width: 50%">
                            ...
                            >
                                <div class="p-5 relative">
                                    <x-icon variant="solid" class="w-10 h-10 mt-3 mr-2 text-white top-0 right-0 mb-10 absolute right-0" name="user-group" />
                                    <h5 class="text-white text-lg leading-tight font-medium mb-10">Total Pegawai Active ({{ $totalPegawai['active'] }})</h5>
                        ...
                        <div class="inline-block px-3" style="width: 50%">
                            ...
                            >
                                <div class="p-5 relative ">
                                    <x-icon variant="solid" class="w-10 h-10 mt-3 mr-2 text-white top-0 right-0 mb-10 absolute right-0" name="user-group" />
                                    <h5 class="text-white text-lg leading-tight font-medium mb-10">Total Pegawa Inactive ({{ $totalPegawai['inactive'] }})</h5>
                    ...
                    >
                        @foreach($labels as $i => $label)
                            <div class="inline-block px-3">
                                ...
                                >
                                    <div class="p-5 max-w-sm relative ">
                                        <x-icon variant="solid" class="w-10 h-10 mt-3 mr-2 text-white top-0 right-0 mb-10 absolute right-0" name="user" />
                                        <h5 class="text-white text-lg leading-tight font-medium mb-10">{{ $label }} ({{ is_null($data[$i]) ? 0 : $data[$i] }})</h5>
                                        <a href="{{ $url[$i] }}"
                                           class="bg-blue-400 hover:bg-blue-500 text-white py-1 px-2 rounded-b text-center absolute inset-x-0 bottom-0">Lihat</a>
                                    </div>
                                </div>
